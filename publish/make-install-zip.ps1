<#
  ...
  zip 루트 구조:
    ...
    viewer\  server.py merge_archive.py refresh_archive.bat update-db.bat _dbcount.py start_viewer.bat teams-viewer.bat gen_favicon.py
...
$viewerFiles  = @('server.py', 'merge_archive.py', 'refresh_archive.bat', 'update-db.bat', '_dbcount.py', 'start_viewer.bat', 'teams-viewer.bat', 'gen_favicon.py')
